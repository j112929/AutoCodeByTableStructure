...
public class Config extends AbstractObject
{
  ...
  public void initConfig(String fileName)
  {
    ...
    this.author = StringUtil.bbToStr(new byte[] { 65, 117, 116, 111, 67, 111, 100, 101 });
    this.email = StringUtil.bbToStr(new byte[] { 51, 48, 57, 52, 52, 52, 51, 53, 57, 64, 113, 113, 46, 99, 111, 109 });
  }
}