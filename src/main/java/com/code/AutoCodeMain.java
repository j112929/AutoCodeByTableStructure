...
public class AutoCodeMain
{
    ...
    throws Exception
  {
    ...
    LOGGER.info("数据库表总数量【{}】", new Object[] { Integer.valueOf(myClassList.size()) });
  ...
  public static void code(MyClass myClass)
  {
    ...
    if (Config.getInstall().isWriteToProject)
    {
      ...
      String dao = Config.getInstall().dao + packageName + myClass.getNameFU() + "Dao.java";

      String service = Config.getInstall().service + packageName + myClass.getNameFU() + "Service.java";
